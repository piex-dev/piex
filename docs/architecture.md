...
├── extensions/                      # 🧩 pi extension 包（TS，走 pi.extensions）
│   ├── hashline/
│   │   ├── README.md
│   │   ├── package.json
│   │   ├── src/                     # hashline.ts, bun-polyfill.ts, filesystem.ts, patches.ts
│   │   └── test/                    # hashline.test.ts
│   ├── dap/
│   │   ├── README.md
│   │   ├── package.json
│   │   └── src/                     # dap.ts, client.ts, session.ts, config.ts, types.ts, utils.ts, defaults.json, non-interactive-env.ts
│   ├── lsp/
│   │   ├── README.md
│   │   ├── package.json
│   │   ├── src/                     # lsp.ts, defaults.json
│   │   └── test/                    # lsp.test.ts, fixtures/mock-lsp-server.mjs
│   ├── plan/
│   │   ├── README.md
│   │   ├── package.json
│   │   ├── src/                     # plan.ts
...
│   │   ├── README.md
│   │   ├── package.json
│   │   ├── src/                     # xai-oauth.ts, models.ts
│   │   └── test/                    # xai-oauth.test.ts, models.test.ts
│   ├── btw/                         # src/btw.ts
...
| lsp                 | ~1350 行 + 499 行 JSON   | `lsp`                                              | 无（dev: typebox）   | oh-my-pi + OpenCode 写后诊断                                    |
| plan                | 348 行                   | `/plan`, `/todos`                                  | 无                   | pi 示例                                                         |
| review              | 330 行                   | `/review`, `review`                                | 无                   | oh-my-pi                                                        |
| init                | prompt only              | `/init`                                            | 无                   | OpenCode                                                        |
...
| **`lsp`**    | **lsp**      | 读写 | LSP：诊断/导航/rename/code_actions；edit 后自动 ERROR |
