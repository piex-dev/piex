...
包路径：[`packages/theme-dark-terminal`](https://github.com/piex-dev/piex/tree/main/packages/theme-dark-terminal)。
...
- 项目级：`pi install -l ./packages/theme-dark-terminal` 更稳  
