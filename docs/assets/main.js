...
(function () {
  ...
  var T = {
    en: {
      ...
      "pkg.usage.desc":
        "Real-time subscription status in the bar: Kimi usage, Grok credits, and Copilot tier/limit state — switches with the model.",
      "pkg.theme.desc":
    ...
    zh: {
      ...
      "pkg.usage.desc": "状态栏实时展示订阅状态：Kimi 周用量、Grok 周 credits、Copilot 档位/限流，随模型切换。",
